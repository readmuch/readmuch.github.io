 ...
 * - index.html and category HTML pages
 */
...
class BlogBuilder {
    ...
    loadTemplates() {
        ['home.html', 'category.html'].forEach(file => {
    ...
    readPost(category, file) {
        ...
        this.postMarkdown[source] = markdown;
    ...
    writeGeneratedData() {
        const payload = {
            ...
            postMarkdown: this.postMarkdown
        };
    ...
    watch() {
        ...
        ['config/site-config.json', 'templates', 'styles', 'js', ...this.config.categories.map(c => c.dir)]
